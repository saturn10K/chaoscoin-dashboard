...
import { useMarketplace, MarketplaceListing, MarketplaceSale, DynamicPrice } from "../hooks/useMarketplace";
...
export default function MarketplacePanel() {
  const { listings, sales, prices, stats, loading } = useMarketplace();
    ...
    >
      ...
      {stats && (
        <div className="grid grid-cols-3 gap-2 mb-4">
          <StatBox label="Active" value={stats.activeListings} color="#00D4FF" />
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div>
          <div className="text-xs text-gray-300">{rigName}</div>
